...
- **Biquad LPF Filter**: Interactive filter with mouse control
  ...
  - Y-axis: Resonance Q value (0.5 - 16.0, inverted: top = high, bottom = low)
  - Automatic cutoff decay at 1Hz per millisecond
- **Non-realtime Rendering**: WebAudio-independent signal processing
- **250ms Audio Buffers**: New audio generated every 250ms
...
3. Move your mouse to control filter parameters:
   ...
   - **Vertical position (Y)**: Controls resonance/Q value (0.5 - 16.0, inverted: top = high, bottom = low)
4. Listen as new audio is generated every 250ms with the current filter settings
